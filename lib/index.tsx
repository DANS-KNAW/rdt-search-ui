...
export type { ExternalSearchProps as RDTSearchUIProps, EndpointProps } from "../src/context/props";
export type {
  Result,
  ResultBodyProps,
...
export { FacetedSearchProvider, getCurrentEndpoint } from "../src/context/Provider";